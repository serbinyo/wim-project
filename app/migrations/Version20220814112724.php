 ...
 */
final class Version20220814112724 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE lap CHANGE date_create date_create DATETIME NOT NULL');
    }
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE lap CHANGE id id VARCHAR(36) NOT NULL COLLATE `utf8_unicode_ci`, CHANGE breathing_exercise_id breathing_exercise_id VARCHAR(36) NOT NULL COLLATE `utf8_unicode_ci`, CHANGE date_create date_create DATETIME DEFAULT NULL, CHANGE time time VARCHAR(255) NOT NULL COLLATE `utf8_unicode_ci`');
